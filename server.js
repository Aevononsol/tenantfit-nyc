...
async function clientMemo({ zip, business, profile, businessResult }) {
  ...
  const prompt = [
    `Write a concise commercial real estate broker memo for ZIP ${zip} and tenant type "${business}".`,
    "Use plain English for a client deciding whether this business should lease in the area.",
    "Include: verdict, demand profile, competition, local-vs-chain angle, risks, and next diligence steps.",
    "Do not overpromise. Mention that exact block, rent, frontage, and operator quality still matter.",
    "",
